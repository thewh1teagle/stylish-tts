...
def inference(text, ref_s, alpha = 0.3, beta = 0.7, diffusion_steps=5, embedding_scale=1):
    ...
    return out[0].squeeze().cpu().numpy()[..., :-50] # weird pulse at the end of the model, need to be fixed later
...
def main():
    ...
    wav = inference(text, ref_s, alpha=0.3, beta=0.7, diffusion_steps=diffusion_steps, embedding_scale=1)
