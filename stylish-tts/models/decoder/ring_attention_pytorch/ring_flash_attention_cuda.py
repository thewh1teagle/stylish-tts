...
class RingFlashAttentionCUDAFunction(Function):
    ...
    def forward(
        ...
        can_fuse_final_output_normalization = not causal or (
            causal and striped_ring_attn
        )
        ...
        for (ring_rank, (is_first, is_last)), (
            ...
            o, m, lse = flash_attn_forward(
                ...
                return_normalized_output=can_fuse_final_output_normalization
                and is_last,
    ...
    def backward(ctx, do):
        ...
        from .triton_flash_attn import flash_attn_backward
